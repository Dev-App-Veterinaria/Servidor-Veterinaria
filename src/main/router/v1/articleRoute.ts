...
router.post('/', jsonParser, adaptRoute(new AddArticleController(new ArticleGateway())));
/* atualiza um artigo especificando o id */
router.put('/:id', jsonParser, adaptRoute(new UpdateArticleController(new ArticleGateway())));
